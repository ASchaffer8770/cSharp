#pragma checksum "C:\Users\alexL\Desktop\C#\AdeptlyAdaptive\AdeptlyAdaptive\MainPage.xaml" "{8829d00f-11b8-4213-878b-770e8597ac16}" "B6383D9854C269B36C0422CED0FE1E7E9A4391758815F584E7A09C00A2E6545F"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace AdeptlyAdaptive
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj8_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::AdeptlyAdaptive.Models.NewsItem dataRoot;
            ...
            {
                if (lineNumber == 90 && columnNumber == 40)
                {
                    isobj9SourceDisabled = true;
                }
                else if (lineNumber == 92 && columnNumber == 48)
                {
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::AdeptlyAdaptive.Models.NewsItem) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::AdeptlyAdaptive.Models.NewsItem)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::AdeptlyAdaptive.Models.NewsItem obj, int phase)
            {
                if (obj != null)
                {
        ...
        private class MainPage_obj1_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::AdeptlyAdaptive.MainPage dataRoot;
            private bool initialized = false;
            private const int NOT_PHASED = (1 << 31);
            private const int DATA_CHANGED = (1 << 30);
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::AdeptlyAdaptive.MainPage)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            // Update methods for each path node used in binding steps.
            private void Update_(global::AdeptlyAdaptive.MainPage obj, int phase)
            {
                if (obj != null)
                {
                    if ((phase & (NOT_PHASED | (1 << 0))) != 0)
            ...
            private void Update_NewsItems(global::System.Collections.ObjectModel.ObservableCollection<global::AdeptlyAdaptive.Models.NewsItem> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
