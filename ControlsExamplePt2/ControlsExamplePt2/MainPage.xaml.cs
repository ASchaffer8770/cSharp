...
namespace ControlsExamplePt2
{
    ...
    { 
        ...
        private string[] selectedItems = new string[] { "Alex", "Tony", "Frank", "Lisa", "Joe", "Noah", "Sam", "Rey", "John", "Mike" };
        ...
        {
            var selectedDates = sender.SelectedDates.Select(x => x.Date.Month.ToString() + "/" + x.Date.Day.ToString()).ToArray();
